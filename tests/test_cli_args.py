...
from main import INPUT_FILE, OUTPUT_DIR, VOICE, parse_args
...
def test_parse_args_overrides_voice() -> None:
    args = parse_args(["--voice", "en-GB-RyanNeural"])
    assert args.voice == "en-GB-RyanNeural"
